    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-mid-green">Draft, edit, and export quotations</p>
        </div>
        <Link
          href="/quotes/new"
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {quotes.length === 0 ? (
              ...
              quotes.map((q, i) => (
                <tr key={q.id} className={i % 2 === 1 ? "bg-light-green/10" : undefined}>
                  ...
                  <td className="px-4 py-3">{q.withGst ? "With GST" : "Without GST"}</td>
